...
ggplot(heatmapintplot, aes(x = interviewee.x,y = interviewee.y)) + 
  ...
  scale_fill_manual(values = c("#bcb8b1","#c9b38d","#cc9943","#d8911a","#f29b09","white"),guide = guide_legend(title = NULL)) +
  coord_fixed() +
...
ggplot(heatmapauthplot, aes(x = author.x,y = author.y)) + 
  ...
  theme(axis.line = element_blank(), 
        ...
        axis.ticks = element_blank(),
        axis.text.x = element_text(angle = 75, hjust = 1)) +
  scale_fill_manual(values = c("#bcb8b1","#c9b38d","#cc9943","#d8911a","white"),guide = guide_legend(title = NULL)) +
  coord_fixed() +
